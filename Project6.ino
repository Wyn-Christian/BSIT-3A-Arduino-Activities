/*
  ...
  Title: PR6 - 7 Segment
  Description: we are going to write a program turning each segment ON and OFF for a count 0-9.
...
void loop()
{
  ...
  if (COUNT == 10)
  {
    COUNT = 0; // if count integer value is equal to 10, reset it tozero.
    delay(1000);
  }
}